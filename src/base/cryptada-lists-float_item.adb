...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-lists-float_item.adb
...
package body CryptAda.Lists.Float_Item is
   ...
   begin
      ...
      Raise_Exception(
         ...
         "In_list does not contain a float item with value: " & Number_2_Text(Value));
