...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-lists-string_item.adb
...
package body CryptAda.Lists.String_Item is
   ...
   begin
      ...
      Raise_Exception(
         ...
         "In_list does not contain a string item with value: """ & Value & """");
