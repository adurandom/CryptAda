...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-lists-integer_item.adb
...
package body CryptAda.Lists.Integer_Item is
   ...
   begin
      ...
      Raise_Exception(
         ...
         "In_list does not contain an integer item with value: " & Number_2_Text(Value));
   end Position_By_Value;

end CryptAda.Lists.Integer_Item;