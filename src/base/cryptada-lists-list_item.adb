...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-lists-list_item.adb
...
package body CryptAda.Lists.List_Item is
   ...
   begin
      ...
      Raise_Exception(
         ...
         "In_list does not contain a list item with the value provided");
   end Position_By_Value;

end CryptAda.Lists.List_Item;