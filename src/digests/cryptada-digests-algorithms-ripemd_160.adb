...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-digests-algorithms-ripemd_160.adb
...
package body CryptAda.Digests.Algorithms.RIPEMD_160 is
   ...
   is
      ...
      Chunks         : Natural := Tot_Bytes / RIPEMD_160_Block_Bytes;
      New_BIB        : constant Natural := Tot_Bytes mod RIPEMD_160_Block_Bytes;
   ...
   begin
      ...
      if Chunks > 0 then
         ...
         if The_Digest.BIB > 0 then
            To_Copy := RIPEMD_160_Block_Bytes - The_Digest.BIB;
            The_Digest.Buffer(The_Digest.BIB + 1 .. RIPEMD_160_Block_Bytes) := The_Bytes(I .. I + To_Copy - 1);
         ...
         while Chunks > 0 loop
            Transform(The_Digest.State, The_Bytes(I .. I + RIPEMD_160_Block_Bytes - 1));
   ...
   begin
      ...
      if To_Pad > 0 then
         The_Digest.Buffer(The_Digest.BIB + 1 .. RIPEMD_160_Block_Bytes) := RIPEMD_160_Pad(1 .. To_Pad);
      end if;
      ...
      The_Digest.Buffer(Bit_Counter_Offset .. RIPEMD_160_Block_Bytes) := UC(1 .. 8);
      Transform(The_Digest.State, The_Digest.Buffer);
   ...
   is
   begin
      The_Digest.Algorithm_Id := MD_RIPEMD_160;
      The_Digest.State_Size   := RIPEMD_160_State_Bytes;
      The_Digest.Block_Size   := RIPEMD_160_Block_Bytes;
      The_Digest.Hash_Size    := RIPEMD_160_Hash_Bytes;
      The_Digest.Bit_Count    := Zero;
