...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-digests-algorithms-snefru.adb
...
package body CryptAda.Digests.Algorithms.Snefru is
   ...
   --[Snefru_Algorithm_Id]------------------------------------------------------
   -- Snefru algorithm identifier.
   -----------------------------------------------------------------------------

   Snefru_Algorithm_Id     : constant array(Snefru_Security_Level, Snefru_Hash_Size) of Digest_Algorithm_Id := (
         Security_Level_4 => (
            Snefru_128  => MD_Snefru_128_4,
            Snefru_256  => MD_Snefru_256_4
         ),
         Security_Level_8 => (
            Snefru_128  => MD_Snefru_128_8,
            Snefru_256  => MD_Snefru_256_8
         )
      );
   ...
   is
   begin
      Digest_Start(The_Digest, Snefru_Security_Level'Last, Snefru_Hash_Size'Last);
   end Digest_Start;
   ...
   is
      Block_Size     : constant Positive := Snefru_Block_Sizes(The_Digest.Hash_Size_Id);
   ...
   begin
      ...
      if Chunks > 0 then
         ...
         if The_Digest.BIB > 0 then
            ...
            Transform(The_Digest.State, The_Digest.Security_Level, The_Digest.Hash_Size_Id, The_Digest.Buffer);
         ...
         while Chunks > 0 loop
            Transform(The_Digest.State, The_Digest.Security_Level, The_Digest.Hash_Size_Id, The_Bytes(I .. I + Block_Size - 1));
   ...
   is
      Block_Size     : constant Positive := Snefru_Block_Sizes(The_Digest.Hash_Size_Id);
      Counter_Offset : constant Positive := 1 + Block_Size - 8;
   ...
   begin
      ...
      if The_Digest.BIB > 0 then
         The_Digest.Buffer(The_Digest.BIB + 1 .. Block_Size) := (others => 0);
         Transform(The_Digest.State, The_Digest.Security_Level, The_Digest.Hash_Size_Id, The_Digest.Buffer);
      end if;
      ...
      The_Digest.Buffer(Counter_Offset .. Block_Size) := UC(9 .. 16);
      Transform(The_Digest.State, The_Digest.Security_Level, The_Digest.Hash_Size_Id, The_Digest.Buffer);

      -- Get hash.

      Hash_Bytes := Unpack_State(The_Digest.State);
      Set_Hash(Hash_Bytes(1 .. Snefru_Hash_Bytes(The_Digest.Hash_Size_Id)), The_Hash);
   ...
   is
   begin
      The_Digest.Algorithm_Id    := Snefru_Algorithm_Id(Security_Level, Hash_Size_Id);
      The_Digest.State_Size      := Snefru_Hash_Bytes(Hash_Size_Id);
      The_Digest.Block_Size      := Snefru_Block_Sizes(Hash_Size_Id);
      The_Digest.Hash_Size       := Snefru_Hash_Bytes(Hash_Size_Id);
      The_Digest.Security_Level  := Security_Level;
   ...
   is
   begin
      return From_Digest.Security_Level;
   ...
   is
   begin
      The_Digest.Algorithm_Id    := MD_Snefru_256_8;
      The_Digest.State_Size      := Snefru_Max_State_Bytes;
      The_Digest.Block_Size      := Snefru_Max_Block_Bytes;
      The_Digest.Hash_Size       := Snefru_Hash_Bytes(Snefru_Hash_Size'Last);
      The_Digest.Security_Level  := Snefru_Security_Level'Last;
      The_Digest.Hash_Size_Id    := Snefru_Hash_Size'Last;
      The_Digest.Bit_Count       := Zero;
      The_Digest.State           := (others => 0);
      The_Digest.BIB             := 0;
      The_Digest.Buffer          := (others => 0);
