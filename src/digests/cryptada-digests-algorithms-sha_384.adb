...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-digests-algorithms-sha_384.adb
...
package body CryptAda.Digests.Algorithms.SHA_384 is
   ...
   is
      ...
      Chunks         : Natural := Tot_Bytes / SHA_384_Block_Bytes;
      New_BIB        : constant Natural := Tot_Bytes mod SHA_384_Block_Bytes;
   ...
   begin
      ...
      if Chunks > 0 then
         ...
         if The_Digest.BIB > 0 then
            To_Copy := SHA_384_Block_Bytes - The_Digest.BIB;
            The_Digest.Buffer(The_Digest.BIB + 1 .. SHA_384_Block_Bytes) := The_Bytes(I .. I + To_Copy - 1);
         ...
         while Chunks > 0 loop
            Transform(The_Digest.State, The_Bytes(I .. I + SHA_384_Block_Bytes - 1));
   ...
   is
      ...
      To_Pad         : constant Natural := SHA_384_Block_Bytes - The_Digest.BIB;
   ...
   begin
      ...
      if To_Pad > 0 then
         The_Digest.Buffer(The_Digest.BIB + 1 .. SHA_384_Block_Bytes) := SHA_384_Pad(1 .. To_Pad);
      end if;
      ...
      The_Digest.Buffer(Bit_Counter_Offset .. SHA_384_Block_Bytes) := UC;
      Transform(The_Digest.State, The_Digest.Buffer);
   ...
   is
   begin
      The_Digest.Algorithm_Id := MD_SHA_384;
      The_Digest.State_Size   := SHA_384_State_Bytes;
      The_Digest.Block_Size   := SHA_384_Block_Bytes;
      The_Digest.Hash_Size    := SHA_384_Hash_Bytes;
