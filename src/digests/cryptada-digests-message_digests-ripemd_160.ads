...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-digests-message_digests-ripemd_160.ads
...
package CryptAda.Digests.Message_Digests.RIPEMD_160 is
   ...
   type RIPEMD_160_Digest is new Message_Digest with private;

   --[RIPEMD_160_Digest_Ptr]----------------------------------------------------
   -- Access to RIPEMD-160 digest objects.
   -----------------------------------------------------------------------------

   type RIPEMD_160_Digest_Ptr is access all RIPEMD_160_Digest'Class;
   ...
   --[Digest_Start]-------------------------------------------------------------
   -- RIPEMD-160 does not take any parameters. So this procedure, reverts to 
...
private
   ...
   type RIPEMD_160_Digest is new Message_Digest with
      record
