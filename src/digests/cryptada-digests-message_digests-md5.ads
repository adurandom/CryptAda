...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-digests-message_digests-md5.ads
...
package CryptAda.Digests.Message_Digests.MD5 is
   ...
   type MD5_Digest is new Message_Digest with private;

   --[MD5_Digest_Ptr]-----------------------------------------------------------
   -- Access to MD5 digest objects.
   -----------------------------------------------------------------------------

   type MD5_Digest_Ptr is access all MD5_Digest'Class;
   ...
   --[Digest_Start]-------------------------------------------------------------
   -- MD5 does not take any parameters. So this procedure, reverts to default
...
private
   ...
   type MD5_Digest is new Message_Digest with
      record
