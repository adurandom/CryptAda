...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-digests-algorithms-sha_512.ads
...
package CryptAda.Digests.Algorithms.SHA_512 is
   ...
   type SHA_512_Digest is new Digest_Algorithm with private;
...
private
   ...
   type SHA_512_Digest is new Digest_Algorithm with
      record
