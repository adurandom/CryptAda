...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-digests-algorithms-sha_3.ads
...
package CryptAda.Digests.Algorithms.SHA_3 is
   ...
   type SHA_3_Digest is new Digest_Algorithm with private;
   ...
   -----------------------------------------------------------------------------
   -- Arguments:
   -- The_Digest           SHA_3_Digest object that maintains the context
   ...
   -----------------------------------------------------------------------------
   -- Arguments:
   -- From_Digest          SHA_3_Digest object that maintains the context
   --                      for digest computation.
   -----------------------------------------------------------------------------
   -- Returned value:
...
private
   ...
   type SHA_3_Digest is new Digest_Algorithm with
      record
         Hash_Size_Id            : SHA_3_Hash_Size := SHA_3_Hash_Size'Last;
