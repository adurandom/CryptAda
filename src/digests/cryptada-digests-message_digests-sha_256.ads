...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-digests-message_digests-sha_256.ads
...
package CryptAda.Digests.Message_Digests.SHA_256 is
   ...
   type SHA_256_Digest is new Message_Digest with private;

   --[SHA_256_Digest_Ptr]-------------------------------------------------------
   -- Access to SHA-256 digest objects.
   -----------------------------------------------------------------------------

   type SHA_256_Digest_Ptr is access all SHA_256_Digest'Class;
   ...
   --[Digest_Start]-------------------------------------------------------------
   -- SHA-256 does not expect any parameters, this procedure reverts to default
...
private
   ...
   type SHA_256_Digest is new Message_Digest with
      record
