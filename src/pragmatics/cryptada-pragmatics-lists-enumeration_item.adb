...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-pragmatics-lists-enumeration_item.adb
...
package body CryptAda.Pragmatics.Lists.Enumeration_Item is
      ...
      if IP.all.Kind = Identifier_Item_Kind then
         if IP.all.Enumerated then
            ...
            if Enumeration'Pos(Value) = IP.all.Enum_Pos then
               ...
               Raise_Exception(CryptAda_Item_Kind_Error'Identity, "Enumeration value error");
            end if;
         else
   ...
   begin
      ...
      Raise_Exception(CryptAda_Item_Not_Found_Error'Identity, "Not found an enumerated item with value: """ & IT & """");
