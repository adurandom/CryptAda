...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-pragmatics-lists-integer_item.ads
...
--------------------------------------------------------------------------------
-- 2. Purpose:
--    This is a generic package for manipulating integer values in lists.
--------------------------------------------------------------------------------
-- 3. Revision history
--    Ver   When     Who   Why
--    ----- -------- ----- -----------------------------------------------------
...
generic
   ...
   --[Number]-------------------------------------------------------------------
   -- The integer type to instantiate the package to.
   -----------------------------------------------------------------------------

   type Number is range <>;
package CryptAda.Pragmatics.Lists.Integer_Item is
   ...
   -- Ada.Text_IO.Integer_IO.Put procedure.
   -----------------------------------------------------------------------------
   -- Arguments:
