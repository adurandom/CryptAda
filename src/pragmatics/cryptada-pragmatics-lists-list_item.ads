...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-pragmatics-lists-list_item.ads
...
--------------------------------------------------------------------------------
-- 2. Purpose:
--    This package manipulates the list items within lists.
--------------------------------------------------------------------------------
-- 3. Revision history
--    Ver   When     Who   Why
--    ----- -------- ----- -----------------------------------------------------
...
package CryptAda.Pragmatics.Lists.List_Item is
   ...
   -- Value             List value returned. Subsequent modifications of 
   --                   either From_List or Value do no affect the other.
   -----------------------------------------------------------------------------
   -- Returned value:
   -- N/A.
   -----------------------------------------------------------------------------
   ...
   -- of a list item value with the value equal to the current list value of a
   -- provided list.
   -----------------------------------------------------------------------------
   -- Arguments:
   -- In_List           List object whose current list is to be searched for
   --                   an identifier value with a value equal to Value.
   -- Value             List value whose current list is searched for
