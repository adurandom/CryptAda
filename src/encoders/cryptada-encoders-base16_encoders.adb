...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-encoders-base16_encoders.adb
...
package body CryptAda.Encoders.Base16_Encoders is
   ...
   exception
      when CryptAda_Syntax_Error =>
         Clear_Base16_Encoder(The_Encoder);
         raise;
   end Decode;
