...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-tests-unit-haval.adb
...
--------------------------------------------------------------------------------
-- 2. Purpose:
--    Unit tests for CryptAda.Digests.Algorithms.HAVAL
--------------------------------------------------------------------------------
-- 3. Revision history
--    Ver   When     Who   Why
--    ----- -------- ----- -----------------------------------------------------
...
package body CryptAda.Tests.Unit.HAVAL is

   -----------------------------------------------------------------------------
   --[Constants]----------------------------------------------------------------
   -----------------------------------------------------------------------------

   Driver_Name                   : constant String := "CryptAda.Tests.Unit.HAVAL";

   Driver_Description            : constant String := "Unit test driver for CryptAda.Digests.Algorithms.HAVAL functionality.";
   ...
   procedure   Print_HAVAL_Info(
                  Digest         : in     HAVAL_Digest);
   ...
   begin
      ...
      Print_Message("Passes                        : " & HAVAL_Passes'Image(Get_Passes(Digest)), "    ");
      Print_Message("Hash size id                  : " & HAVAL_Hash_Size'Image(Get_Hash_Size_Id(Digest)), "    ");
   end Print_HAVAL_Info;
  ...
  --[Case_1]-------------------------------------------------------------------
   ...
   begin
      ...
      for I in HAVAL_Passes'Range loop
         for J in HAVAL_Hash_Size'Range loop
            Print_Information_Message("HAVAL digest parameters:");
            Print_Message("Passes                        : """ & HAVAL_Passes'Image(I) & """", "    ");
            Print_Message("Hash size id                  : """ & HAVAL_Hash_Size'Image(J) & """", "    ");
   ...
   is
      ...
      R           : Boolean;
   begin
      Begin_Test_Case(3, "CryptAda HAVAL (128-bit) test vectors");
      ...
      for J in HAVAL_Passes'Range loop
         ...
         for I in  1 .. Test_Vector_Count loop
            Digest_Start(D, J, HAVAL_128);
            Run_CryptAda_Test_Vector(D, I, CryptAda_Test_Vector_Hashes_128(J, I).all, R);
   ...
   is
      ...
      R           : Boolean;
   begin
      Begin_Test_Case(4, "CryptAda HAVAL (160-bit) test vectors");
      Print_Information_Message("Obtained hashes are checked against values obtained by using several online tools");
      ...
      for J in HAVAL_Passes'Range loop
         ...
         for I in  1 .. Test_Vector_Count loop
            Digest_Start(D, J, HAVAL_160);
            Run_CryptAda_Test_Vector(D, I, CryptAda_Test_Vector_Hashes_160(J, I).all, R);
   ...
   is
      ...
      R           : Boolean;
   begin
      Begin_Test_Case(5, "CryptAda HAVAL (192-bit) test vectors");
      Print_Information_Message("Obtained hashes are checked against values obtained by using several online tools");
      ...
      for J in HAVAL_Passes'Range loop
         ...
         for I in  1 .. Test_Vector_Count loop
            Digest_Start(D, J, HAVAL_192);
            Run_CryptAda_Test_Vector(D, I, CryptAda_Test_Vector_Hashes_192(J, I).all, R);
   ...
   is
      ...
      R           : Boolean;
   begin
      Begin_Test_Case(6, "CryptAda HAVAL (224-bit) test vectors");
      Print_Information_Message("Obtained hashes are checked against values obtained by using several online tools");
      ...
      for J in HAVAL_Passes'Range loop
         ...
         for I in  1 .. Test_Vector_Count loop
            Digest_Start(D, J, HAVAL_224);
            Run_CryptAda_Test_Vector(D, I, CryptAda_Test_Vector_Hashes_224(J, I).all, R);
   ...
   is
      ...
      R           : Boolean;
   begin
      Begin_Test_Case(7, "CryptAda HAVAL (256-bit) test vectors");
      Print_Information_Message("Obtained hashes are checked against values obtained by using several online tools");
      ...
      for J in HAVAL_Passes'Range loop
         ...
         for I in  1 .. Test_Vector_Count loop
            Digest_Start(D, J, HAVAL_256);
            Run_CryptAda_Test_Vector(D, I, CryptAda_Test_Vector_Hashes_256(J, I).all, R);
   ...
   is
      ...
      Len         : Positive;
   begin
      Begin_Test_Case(8, "Testing HAVAL operation (128-bit) at counter offset and block boundary.");
      Print_Information_Message("Obtained hashes are checked against values obtained by using several online tools");
   ...
   is
      ...
      Len         : Positive;
   begin
      Begin_Test_Case(9, "Testing HAVAL operation (160-bit) at counter offset and block boundary.");
      Print_Information_Message("Obtained hashes are checked against values obtained by using several online tools");
   ...
   is
      ...
      Len         : Positive;
   begin
      Begin_Test_Case(10, "Testing HAVAL operation (192-bit) at counter offset and block boundary.");
      Print_Information_Message("Obtained hashes are checked against values obtained by using several online tools");
   ...
   is
      ...
      Len         : Positive;
   begin
      Begin_Test_Case(11, "Testing HAVAL operation (224-bit) at counter offset and block boundary.");
      Print_Information_Message("Obtained hashes are checked against values obtained by using several online tools");
   ...
   is
      ...
      Len         : Positive;
   begin
      Begin_Test_Case(12, "Testing HAVAL operation (256-bit) at counter offset and block boundary.");
      Print_Information_Message("Obtained hashes are checked against values obtained by using several online tools");
