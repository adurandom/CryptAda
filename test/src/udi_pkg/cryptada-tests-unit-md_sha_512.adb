...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-tests-unit-md_sha_512.adb
...
--------------------------------------------------------------------------------
-- 2. Purpose:
--    Unit test for CryptAda.Digests.Message_Digests.SHA_512.
--------------------------------------------------------------------------------
-- 3. Revision history
--    Ver   When     Who   Why
--    ----- -------- ----- -----------------------------------------------------
...
package body CryptAda.Tests.Unit.MD_SHA_512 is

   -----------------------------------------------------------------------------
   --[Constants]----------------------------------------------------------------
   -----------------------------------------------------------------------------

   Driver_Name                   : constant String := "CryptAda.Tests.Unit.MD_SHA_512";

   Driver_Description            : constant String := "Unit test driver for CryptAda.Digests.Message_Digests.SHA_512 functionality.";
  ...
  --[Case_1]-------------------------------------------------------------------
   ...
   begin
      ...
      Print_Message("SHA_512 is not parametrizable", "    ");
   ...
   begin
      ...
      Print_Information_Message("SHA_512 does not accept any parameter. So any valid Parameter list is ignored");
...
end CryptAda.Tests.Unit.MD_SHA_512;
