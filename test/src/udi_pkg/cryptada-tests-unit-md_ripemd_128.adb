...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-tests-unit-md_ripemd_128.adb
...
--------------------------------------------------------------------------------
-- 2. Purpose:
--    Unit test for CryptAda.Digests.Message_Digests.RIPEMD_128.
--------------------------------------------------------------------------------
-- 3. Revision history
--    Ver   When     Who   Why
--    ----- -------- ----- -----------------------------------------------------
...
package body CryptAda.Tests.Unit.MD_RIPEMD_128 is

   -----------------------------------------------------------------------------
   --[Constants]----------------------------------------------------------------
   -----------------------------------------------------------------------------

   Driver_Name                   : constant String := "CryptAda.Tests.Unit.MD_RIPEMD_128";

   Driver_Description            : constant String := "Unit test driver for CryptAda.Digests.Message_Digests.RIPEMD_128 functionality.";
  ...
  --[Case_1]-------------------------------------------------------------------
   ...
   begin
      ...
      Print_Message("RIPEMD_128 is not parametrizable", "    ");
   ...
   begin
      ...
      Print_Information_Message("RIPEMD_128 does not accept any parameter. So any valid Parameter list is ignored");
   ...
   is
      ...
      R           : Boolean;
   begin
      Begin_Test_Case(4, "Standard RIPEMD-128 test vectors");
   ...
   is
      ...
      R           : Boolean;
   begin
      Begin_Test_Case(5, "CryptAda RIPEMD-128 test vectors");
   ...
   is
      ...
      HO          : Hash;
   begin
      Begin_Test_Case(6, "Testing RIPEMD-128 operation at counter offset and block boundary.");
      Print_Information_Message("Obtained hashes are checked against values obtained by using several online tools");
   ...
   is
      ...
      HO                   : Hash;
   begin
      Begin_Test_Case(7, "Another standard RIPEMD-128 test vector: 1,000,000 repetitions of 'a'");
...
end CryptAda.Tests.Unit.MD_RIPEMD_128;
