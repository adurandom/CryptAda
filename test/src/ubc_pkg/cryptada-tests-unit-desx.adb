...
package body CryptAda.Tests.Unit.DESX is
   ...
   Inv_Par_Lists              : constant array(1 .. Inv_Par_List_Count) of String_Ptr := 
      (
         ...
         new String'("(Operation => Encrypt, Key => ""01020304 05060708"")"),    -- Syntax incorrect key value
  ...
  --[Case_1]-------------------------------------------------------------------
   ...
   is
      ...
      KB          : constant Byte_Array(1 .. DESX_Key_Length) := (others => 16#11#);
      K           : Key;
   begin
  ...
  --[Case_2]--------------------------------------------------------------------
   ...
   begin
      Begin_Test_Case(2, "Running DESX_Cipher basic tests");
      Run_Block_Cipher_Basic_Tests(SCH, "Basic test for DESX_Cipher");
      Invalidate_Handle(SCH);
      Print_Information_Message("Test case OK");
  ...
  --[Case_3]--------------------------------------------------------------------
   ...
   is
      ...
      L           : List;
      LT1         : constant String := "(Operation => Encrypt, Key => ""000102030405060708090a0b0c0d0e0f1011121314151617"")";
      LT2         : constant String := "(Operation => Decrypt, Key => ""000102030405060708090a0b0c0d0e0f1011121314151617"")";
      B           : constant DESX_Block := (others => 16#FF#);
      CTB         : DESX_Block;
      PTB         : DESX_Block;
   begin
  ...
  --[Case_4]--------------------------------------------------------------------
   ...
   is
      ...
      K                    : Key;
   begin
      Begin_Test_Case(4, "Testing DESX_Cipher non dispatching operations");
  ...
  --[Case_5]--------------------------------------------------------------------
   ...
   is
      ...
      R                    : Boolean;
   begin
      Begin_Test_Case(5, "DESX standard test vectors");
  ...
  --[Case_6]--------------------------------------------------------------------
   ...
   is
      SCH                  : Symmetric_Cipher_Handle := Get_Symmetric_Cipher_Handle;
   begin
      Begin_Test_Case(6, "DESX Bulk test");
      
      Run_Block_Cipher_Bulk_Tests(SCH, DESX_Key_Length);
