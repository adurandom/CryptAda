...
package body CryptAda.Tests.Unit.DESX is
  ...
  --[Case_1]-------------------------------------------------------------------
   ...
   begin
      ...
      declare
         PT_B              : constant DESX_Block := (others => 0);
         CT_B              : DESX_Block;
      begin
  ...
  --[Case_2]-------------------------------------------------------------------
   ...
   is
      C                    : DESX_Cipher;
      KB                   : constant Byte_Array(1 .. DESX_Key_Size) := (others => 0);
      PT_B                 : constant DESX_Block := (8, 7, 6, 5, 4, 3, 2, 1);
      CT_B                 : DESX_Block;
      DPT_B                : DESX_Block;
      K                    : Key;
   begin
  ...
  --[Case_4]-------------------------------------------------------------------
   ...
   is
      ...
      R                    : Boolean;
   begin
      Begin_Test_Case(4, "DESX standard test vectors");
  ...
  --[Case_5]-------------------------------------------------------------------
   ...
   is
      C                    : DESX_Cipher;
   begin
      Begin_Test_Case(5, "DESX Bulk test");
      
      Run_Cipher_Bulk_Test(C, DESX_Key_Size);
