...
package body CryptAda.Tests.Time.RIPEMD_128 is
   ...
   Driver_Description            : constant String := "Time trial for CryptAda.Digests.Algorithms.RIPEMD_128 functionality.";
   ...
   is
      ...
      Elapsed     : Duration;
   begin
      Begin_Time_Trial(1, "RIPEMD_128 hashing");
   ...
   is
      ...
      Elapsed     : Duration;
   begin
      Begin_Time_Trial(2, "RIPEMD_128 hashing");
