...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-tests-time-ripemd_128.adb
...
--------------------------------------------------------------------------------
-- 2. Purpose:
--    Time trial for CryptAda.Digests.Message_Digests.RIPEMD_128.
--------------------------------------------------------------------------------
-- 3. Revision history
--    Ver   When     Who   Why
--    ----- -------- ----- -----------------------------------------------------
...
package body CryptAda.Tests.Time.RIPEMD_128 is

   -----------------------------------------------------------------------------
   --[Constants]----------------------------------------------------------------
   -----------------------------------------------------------------------------

   Driver_Name                   : constant String := "CryptAda.Tests.Time.RIPEMD_128";

   Driver_Description            : constant String := "Time trial for CryptAda.Digests.Message_Digests.RIPEMD_128 functionality.";
   ...
   is
      ...
      Elapsed     : Duration;
   begin
      Begin_Time_Trial(1, "RIPEMD-128 hashing");
   ...
   is
      ...
      Elapsed     : Duration;
   begin
      Begin_Time_Trial(2, "RIPEMD-128 hashing");
