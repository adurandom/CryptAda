...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-tests-time-blake_256.adb
...
package body CryptAda.Tests.Time.BLAKE_256 is

   -----------------------------------------------------------------------------
   --[Constants]----------------------------------------------------------------
   -----------------------------------------------------------------------------

   Driver_Name                   : constant String := "CryptAda.Tests.Time.BLAKE_256";

   Driver_Description            : constant String := "Time trial for CryptAda.Digests.Message_Digests.BLAKE_256 functionality.";
   ...
   is
      ...
      Elapsed     : Duration;
   begin
      Begin_Time_Trial(1, "BLAKE-256 hashing");
   ...
   is
      ...
      Elapsed     : Duration;
   begin
      Begin_Time_Trial(2, "BLAKE-256 hashing");
...
end CryptAda.Tests.Time.BLAKE_256;
