...
package body CryptAda.Tests.Time.RIPEMD_160 is
   ...
   Driver_Description            : constant String := "Time trial for CryptAda.Digests.Algorithms.RIPEMD_160 functionality.";
   ...
   is
      ...
      Elapsed     : Duration;
   begin
      Begin_Time_Trial(1, "RIPEMD_160 hashing");
   ...
   is
      ...
      Elapsed     : Duration;
   begin
      Begin_Time_Trial(2, "RIPEMD_160 hashing");
