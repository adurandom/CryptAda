...
--------------------------------------------------------------------------------
-- 1. Identification
--    Filename          :  cryptada-tests-unit-base16_encoders.adb
...
--------------------------------------------------------------------------------
-- 2. Purpose:
--    Unit tests for CryptAda.Encoders.Base16_Encoders
--------------------------------------------------------------------------------
-- 3. Revision history
--    Ver   When     Who   Why
--    ----- -------- ----- -----------------------------------------------------
...
with CryptAda.Encoders.Base16_Encoders;
use CryptAda.Encoders.Base16_Encoders;

package body CryptAda.Tests.Unit.Base16_Encoders is

   -----------------------------------------------------------------------------
   --[Constants]----------------------------------------------------------------
   -----------------------------------------------------------------------------

   Driver_Name                   : constant String := "CryptAda.Tests.Unit.Base16_Encoders";
   Driver_Description            : constant String := "Unit test driver for CryptAda.Encoders.Base16_Encoders functionality.";
   ...
   is
      H              : Base16_Encoder;
      BV             : Byte_Vector;
      Invalid        : constant array(1 .. 6) of String_Ptr := (
...
end CryptAda.Tests.Unit.Base16_Encoders;
